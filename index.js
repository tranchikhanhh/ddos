...
bot.user.setPresence({
    game: {
        name: `RabbitNXT -> (Release)`,
        type: "STREAMING",
        url: "https://twitch.tv/RabbitNXT"
      }
    }
  );
});
...
if (command === 'help') {
  ...
  const response = new Discord.RichEmbed()
    .setColor("#8b1e9b")
    .setAuthor(`Welcome to the new version of RabbitNXT`,"","https://t.me/fuck")
    .setTitle(":flag_br: - RabbitNXT - Help Menu - :flag_br:")
...
if (command === 'buy') {
  ...
  const privbuyembed = new Discord.RichEmbed()
    ...
    .setColor('#ff0000')
    .setTitle(':flag_br: - RabbitNXT - Buy Menu - :flag_br:')
...
const methodsem = new Discord.RichEmbed()
  .setColor("#ff0000")
  .setTitle(":flag_br: - RabbitNXT - Methods DDoS - :flag_br:")
